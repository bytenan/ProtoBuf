...
const uint32_t TableStruct_del_5fcontact_5frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::del_contact_request::DelContactRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::del_contact_request::DelContactRequest, _impl_.uid_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::del_contact_request::DelContactRequest)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::del_contact_request::_DelContactRequest_default_instance_._instance,
};

const char descriptor_table_protodef_del_5fcontact_5frequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\031del_contact_request.proto\022\023del_contact"
...
const ::_pbi::DescriptorTable descriptor_table_del_5fcontact_5frequest_2eproto = {
    false, false, 90, descriptor_table_protodef_del_5fcontact_5frequest_2eproto,
...
DelContactRequest::DelContactRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:del_contact_request.DelContactRequest)
}
DelContactRequest::DelContactRequest(const DelContactRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:del_contact_request.DelContactRequest)
}
...
DelContactRequest::~DelContactRequest() {
  // @@protoc_insertion_point(destructor:del_contact_request.DelContactRequest)
...
// @@protoc_insertion_point(message_clear_start:del_contact_request.DelContactRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "del_contact_request.DelContactRequest.uid"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* DelContactRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:del_contact_request.DelContactRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_uid().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "del_contact_request.DelContactRequest.uid");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:del_contact_request.DelContactRequest)
  return target;
}

size_t DelContactRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:del_contact_request.DelContactRequest)
  size_t total_size = 0;
...
void DelContactRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:del_contact_request.DelContactRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:del_contact_request.DelContactRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::del_contact_request::DelContactRequest*
Arena::CreateMaybeMessage< ::del_contact_request::DelContactRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::del_contact_request::DelContactRequest >(arena);
}
