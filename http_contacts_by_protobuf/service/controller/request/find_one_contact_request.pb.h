...
PROTOBUF_NAMESPACE_OPEN
template<> ::find_one_contact_request::FindOneContactRequest* Arena::CreateMaybeMessage<::find_one_contact_request::FindOneContactRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace find_one_contact_request {
...
class FindOneContactRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:find_one_contact_request.FindOneContactRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "find_one_contact_request.FindOneContactRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:find_one_contact_request.FindOneContactRequest)
 private:
  class _Internal;
...
inline const std::string& FindOneContactRequest::uid() const {
  // @@protoc_insertion_point(field_get:find_one_contact_request.FindOneContactRequest.uid)
...
void FindOneContactRequest::set_uid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.uid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:find_one_contact_request.FindOneContactRequest.uid)
}
inline std::string* FindOneContactRequest::mutable_uid() {
  std::string* _s = _internal_mutable_uid();
  // @@protoc_insertion_point(field_mutable:find_one_contact_request.FindOneContactRequest.uid)
  return _s;
}
...
inline std::string* FindOneContactRequest::release_uid() {
  // @@protoc_insertion_point(field_release:find_one_contact_request.FindOneContactRequest.uid)
...
inline void FindOneContactRequest::set_allocated_uid(std::string* uid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:find_one_contact_request.FindOneContactRequest.uid)
}
