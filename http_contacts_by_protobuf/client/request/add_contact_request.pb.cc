...
const uint32_t TableStruct_add_5fcontact_5frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_Phone, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_Phone, _impl_.number_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_Phone, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse, key_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse, value_),
  0,
  1,
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest, _impl_.age_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest, _impl_.phone_),
  PROTOBUF_FIELD_OFFSET(::add_contact_request::AddContactRequest, _impl_.remark_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::add_contact_request::AddContactRequest_Phone)},
  { 8, 16, -1, sizeof(::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse)},
  { 18, -1, -1, sizeof(::add_contact_request::AddContactRequest)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::add_contact_request::_AddContactRequest_Phone_default_instance_._instance,
  &::add_contact_request::_AddContactRequest_RemarkEntry_DoNotUse_default_instance_._instance,
  &::add_contact_request::_AddContactRequest_default_instance_._instance,
};

const char descriptor_table_protodef_add_5fcontact_5frequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\031add_contact_request.proto\022\023add_contact"
  "_request\"\354\002\n\021AddContactRequest\022\014\n\004name\030\001"
  " \001(\t\022\013\n\003age\030\002 \001(\005\022;\n\005phone\030\003 \003(\0132,.add_c"
  "ontact_request.AddContactRequest.Phone\022B"
  "\n\006remark\030\004 \003(\01322.add_contact_request.Add"
  "ContactRequest.RemarkEntry\032\213\001\n\005Phone\022\016\n\006"
  "number\030\001 \001(\t\022D\n\004type\030\002 \001(\01626.add_contact"
  "_request.AddContactRequest.Phone.PhoneTy"
...
const ::_pbi::DescriptorTable descriptor_table_add_5fcontact_5frequest_2eproto = {
    false, false, 423, descriptor_table_protodef_add_5fcontact_5frequest_2eproto,
...
constexpr AddContactRequest_Phone_PhoneType AddContactRequest_Phone::MOBILE_PHONE;
constexpr AddContactRequest_Phone_PhoneType AddContactRequest_Phone::TELEPHONE;
...
AddContactRequest_Phone::AddContactRequest_Phone(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:add_contact_request.AddContactRequest.Phone)
}
AddContactRequest_Phone::AddContactRequest_Phone(const AddContactRequest_Phone& from)
  ...
  // @@protoc_insertion_point(copy_constructor:add_contact_request.AddContactRequest.Phone)
}
...
AddContactRequest_Phone::~AddContactRequest_Phone() {
  // @@protoc_insertion_point(destructor:add_contact_request.AddContactRequest.Phone)
...
// @@protoc_insertion_point(message_clear_start:add_contact_request.AddContactRequest.Phone)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "add_contact_request.AddContactRequest.Phone.number"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::add_contact_request::AddContactRequest_Phone_PhoneType>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* AddContactRequest_Phone::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:add_contact_request.AddContactRequest.Phone)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_number().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "add_contact_request.AddContactRequest.Phone.number");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:add_contact_request.AddContactRequest.Phone)
  return target;
}

size_t AddContactRequest_Phone::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:add_contact_request.AddContactRequest.Phone)
  size_t total_size = 0;
...
void AddContactRequest_Phone::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:add_contact_request.AddContactRequest.Phone)
...
// @@protoc_insertion_point(class_specific_copy_from_start:add_contact_request.AddContactRequest.Phone)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
AddContactRequest::AddContactRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:add_contact_request.AddContactRequest)
}
AddContactRequest::AddContactRequest(const AddContactRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:add_contact_request.AddContactRequest)
}
...
AddContactRequest::~AddContactRequest() {
  // @@protoc_insertion_point(destructor:add_contact_request.AddContactRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    ArenaDtor(this);
    return;
...
// @@protoc_insertion_point(message_clear_start:add_contact_request.AddContactRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "add_contact_request.AddContactRequest.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 age = 2;
...
uint8_t* AddContactRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:add_contact_request.AddContactRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "add_contact_request.AddContactRequest.name");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_remark().empty()) {
    ...
    auto check_utf8 = [](const MapType::value_type& entry) {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        ...
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "add_contact_request.AddContactRequest.RemarkEntry.key");
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        entry.second.data(), static_cast<int>(entry.second.length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "add_contact_request.AddContactRequest.RemarkEntry.value");
    };
  ...
  // @@protoc_insertion_point(serialize_to_array_end:add_contact_request.AddContactRequest)
  return target;
}

size_t AddContactRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:add_contact_request.AddContactRequest)
  size_t total_size = 0;
...
void AddContactRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:add_contact_request.AddContactRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:add_contact_request.AddContactRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::add_contact_request::AddContactRequest_Phone*
Arena::CreateMaybeMessage< ::add_contact_request::AddContactRequest_Phone >(Arena* arena) {
  return Arena::CreateMessageInternal< ::add_contact_request::AddContactRequest_Phone >(arena);
}
template<> PROTOBUF_NOINLINE ::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse*
Arena::CreateMaybeMessage< ::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::add_contact_request::AddContactRequest_RemarkEntry_DoNotUse >(arena);
}
template<> PROTOBUF_NOINLINE ::add_contact_request::AddContactRequest*
Arena::CreateMaybeMessage< ::add_contact_request::AddContactRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::add_contact_request::AddContactRequest >(arena);
}
