...
PROTOBUF_NAMESPACE_OPEN
template<> ::del_contact_request::DelContactRequest* Arena::CreateMaybeMessage<::del_contact_request::DelContactRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace del_contact_request {
...
class DelContactRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:del_contact_request.DelContactRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "del_contact_request.DelContactRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:del_contact_request.DelContactRequest)
 private:
  class _Internal;
...
inline const std::string& DelContactRequest::uid() const {
  // @@protoc_insertion_point(field_get:del_contact_request.DelContactRequest.uid)
...
void DelContactRequest::set_uid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.uid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:del_contact_request.DelContactRequest.uid)
}
inline std::string* DelContactRequest::mutable_uid() {
  std::string* _s = _internal_mutable_uid();
  // @@protoc_insertion_point(field_mutable:del_contact_request.DelContactRequest.uid)
  return _s;
}
...
inline std::string* DelContactRequest::release_uid() {
  // @@protoc_insertion_point(field_release:del_contact_request.DelContactRequest.uid)
...
inline void DelContactRequest::set_allocated_uid(std::string* uid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:del_contact_request.DelContactRequest.uid)
}
